...
namespace RxjhServer.RxjhServer
{
	public class PlayersBes : 气功属性
	{
        ...
        public int FLD_Item_Plus_Coat
        {
            get
            {
                if (this._FLD_装备_追加_防具_强化 < 0)
                {
                    this._FLD_装备_追加_防具_强化 = 0;
                }
                return this._FLD_装备_追加_防具_强化;
            }
            set
            {
                this._FLD_装备_追加_防具_强化 = value;
            }
        }
        ...
        public int FLD_装备_追加_武器_强化
        {
            get
            {
                if (this._FLD_装备_追加_武器_强化 < 0)
                {
                    this._FLD_装备_追加_武器_强化 = 0;
                }
                return this._FLD_装备_追加_武器_强化;
            }
            set
            {
                this._FLD_装备_追加_武器_强化 = value;
            }
        }
